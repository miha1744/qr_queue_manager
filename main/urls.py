...
urlpatterns +=[
    ...
    path('patient_stay_queue', views.stay_in_queue,name='patient-stay-queue'),

    path('delete-patient-from-queue/<int:pk>', views.delete_member_from_queue_view,name='delete-patient-from-queue'),
    path('up-patient-from-queue/<int:pk>', views.up_member_from_queue_view,name='up-patient-from-queue'),
    path('down-patient-from-queue/<int:pk>', views.down_member_from_queue_view,name='down-patient-from-queue'),
    path('end-patient-from-queue/<int:pk>', views.end_member_from_queue_view,name='end-patient-from-queue'),
